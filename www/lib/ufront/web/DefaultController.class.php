...
class ufront_web_DefaultController extends ufront_web_Controller {
	...
	public function showMessage() {
		{
			$pos = _hx_anonymous(array("fileName" => "UfrontConfiguration.hx", "lineNumber" => 256, "className" => "ufront.web.DefaultController", "methodName" => "showMessage"));
	...
	public function execute() {
		...
		try {
			...
			throw new HException(ufront_web_HttpError::pageNotFound(_hx_anonymous(array("fileName" => "ControllerMacros.hx", "lineNumber" => 433, "className" => "ufront.web.DefaultController", "methodName" => "execute"))));
		}catch(Exception $__hx__e) {
			$_ex_ = ($__hx__e instanceof HException) ? $__hx__e->e : $__hx__e;
			$e = $_ex_;
			{
				return ufront_core_Sync::httpError("Uncaught error while executing " . Std::string($this->context->actionContext->controller) . "." . _hx_string_or_null($this->context->actionContext->action) . "()", $e, _hx_anonymous(array("fileName" => "ControllerMacros.hx", "lineNumber" => 436, "className" => "ufront.web.DefaultController", "methodName" => "execute")));
			}
		}
	}
